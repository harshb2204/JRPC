...
public class MessagePayload implements Serializable {
    ...
    // Without this, fastjson would serialize the enum as its ordinal number (0, 1,
    // 2...). With it, it serializes
    // as the name ("REGISTER", "CALL"...) — which is more readable and safer
    ...
    public static class RpcRequest implements Serializable {
        ...
        // unique UUID
        private String requestId;
        private String requestMethodSimpleName; // method name

        // interface class name
        // The consumer knows the interface (BookingDetailService). The producer uses
        // this to look up its
        // Spring bean (BookingDetailServiceImpl) via
